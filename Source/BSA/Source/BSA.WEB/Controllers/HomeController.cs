...
namespace BSA.Controllers
{
    public class HomeController : Controller
    {
        ...
        ERPEntities userMenuRepository = new ERPEntities();
        ...
        {
            var senderEmail = new MailAddress("BSA19@gmail.com", "KG");
        ...
        public FileResult DownloadUserManualByPDF()
        {
            ...
            return File(pdfByte, "application/pdf", "BSAHRMSUserManual.pdf");
        }
