        ...
        public bool SaveKttlCustomer(long id, CustomerModel model)
        {
            ...
            try
            {
                ...
                if (id > 0)
                {
                    ...
                    customer.ModifiedBy = System.Web.HttpContext.Current.User.Identity.Name; var memberName = context.Members.Where(x => x.MemberId == System.Web.HttpContext.Current.User.Identity.Name).FirstOrDefault();
                    if (memberName != null)
                    {
                        customer.MemberName = memberName.MemberName;
                    }
                }
                else
                {
                    ...
                    var memberName = context.Members.Where(x => x.MemberId == System.Web.HttpContext.Current.User.Identity.Name).FirstOrDefault();
                    if (memberName != null)
                    {
                        customer.MemberName = memberName.MemberName;
                    }
